    ...
    <Container>
      <div className="box">
        ...
        Check List - Análise Concomitante
            ...
            <Link href="http://www.cap.seduh.df.gov.br/wp-content/uploads/2022/03/Check-List-Regularizacao-Edilicia-Habilitacao-Habite-se-Artigo-151.pdf">
        Check List - Regularização Edilícia - Habilitação Habite-se - Artigo 151
            </Link>
            <Link href="http://www.cap.seduh.df.gov.br/wp-content/uploads/2020/03/CHECK-LIST-REGULARIZA%C3%87%C3%83O-EDIL%C3%8DCIA-ARTIGO-152.pdf">
        Check List - Regularização Edilícia - Habilitação Habite-se - Artigo 152
            </Link>
            <Link href="http://www.cap.seduh.df.gov.br/wp-content/uploads/2022/03/Check-List-Regularizacao-Edilicia-Habilitacao-Habite-se-Artigo-153.pdf">
        Check List - Regularização Edilícia - Habilitação Habite-se - Artigo 153
            </Link>
            <Link href="http://www.cap.seduh.df.gov.br/wp-content/uploads/2022/04/Check-List-Habilitacao-de-Projeto-em-AREA-RURAL-COM-Memorial-Descritivo.pdf">
        Check List - Habilitação de Projeto em ÁREA RURAL COM Memorial Descritivo
            </Link>
            <Link href="http://www.cap.seduh.df.gov.br/wp-content/uploads/2022/04/Check-List-Habilitacao-de-Projeto-em-AREA-RURAL-COM-Plano-de-Utilizacao-da-Unidade-de-Producao-PU.pdf">
        ...
        {secondStage && (
          <div className='buttons'>
            <Link href="http://www.cap.seduh.df.gov.br/wp-content/uploads/2021/11/CHECK-LIST-ALVAR%C3%81-DE-CONSTRU%C3%87%C3%83O-2021.pdf">
        Check List - Alvará de Construção
            </Link>
            <Link href="http://www.cap.seduh.df.gov.br/wp-content/uploads/2022/01/CHECK-LIST-ALVARA-DE-CONSTRUCAO-HABITACAO-UNIFAMILIAR-2022.pdf">
        Check List - Alvará de Construção - Habitação unifamiliar
            </Link>
            <Link href="http://www.cap.seduh.df.gov.br/wp-content/uploads/2021/04/Check-List-Alvar%C3%A1-de-Constru%C3%A7%C3%A3o-RITO-ESPECIAL-2021.pdf">
        Check List - Alvará de Construção - RITO ESPECIAL
            </Link>
            <Link href="http://www.cap.seduh.df.gov.br/wp-content/uploads/2022/03/Check-List-Licencas-Especificas.pdf">
        Check List - Licença Específica
            </Link>
            <Link href="http://www.cap.seduh.df.gov.br/wp-content/uploads/2021/09/CHECK-LIST-LICEN%C3%87A-ESPECIFICA-ESTANDE-DE-VENDAS-em-%C3%81REA-P%C3%9ABLICA.pdf">
        Check List - Estande de Vendas
            </Link>
            <Link href="http://www.cap.seduh.df.gov.br/wp-content/uploads/2021/04/CHECK-LIST-ENGENHO-PUBLICIT%C3%81RIO-2021.pdf">
        Check List - Engenho Publicitário
            </Link>
            <Link href="http://www.cap.seduh.df.gov.br/wp-content/uploads/2021/09/CHECK-LIST-LICEN%C3%87A-ESPECIFICA-LICE%C3%87A-ESPECIFICA.pdf">
        ...
        {thirdStage && (
          <div className='buttons'>
            <Link href="http://www.cap.seduh.df.gov.br/wp-content/uploads/2021/04/CHECK-LIST-HABITE-SE-2021.pdf">
        Check List - Habite-se
            </Link>
            <Link href="http://www.cap.seduh.df.gov.br/wp-content/uploads/2021/04/CHECK-LIST-ATESTADO-DE-CONCLUS%C3%83O-2021.pdf">
        ...
        {fourthStage && (
          <div className='buttons'>
            <Link href="http://www.cap.seduh.df.gov.br/wp-content/uploads/2022/10/Check-List-Puxadinho-Asa-Sul-Lei-988-2022-e-Decreto-43.609-2022.pdf">
        Check List - Puxadinho Asa Sul - Lei 988/2022
            </Link>



            <Link href="http://www.cap.seduh.df.gov.br/wp-content/uploads/2020/03/CHECK-LIST-PLANO-DE-OCUPA%C3%87%C3%83O.pdf">
        ...
        {fifthStage && (
          ...
          Tabela para cálculo dos Valores de Licenciamento de Obras e Edificações
            ...
            <Link href='http://www.cap.seduh.df.gov.br/wp-content/uploads/2023/01/CALCULO-TAXAS-2023-ajustado.xlsx'>
          Planilha de cálculo da taxas referente ao processo de licenciamento de obras
            </Link>
            <Link href='http://www.cap.seduh.df.gov.br/wp-content/uploads/2021/06/COMPENSA%C3%87%C3%83O-URBANISTICA-.xlsx'>
          Simulador de Taxa de Compensação Urbanística

            </Link>
            <Link href='http://www.cap.seduh.df.gov.br/wp-content/uploads/2021/06/tabela-analise-compensacao-urbanistica.xlsx'>
          Cálculo de taxa de análise e emissão de TAR (Compensação Urbanística)
            </Link>
            <Link href='http://www.cap.seduh.df.gov.br/wp-content/uploads/2021/06/CALCULO-ODIR-.xlsx'>
          Cálculo ODIR
